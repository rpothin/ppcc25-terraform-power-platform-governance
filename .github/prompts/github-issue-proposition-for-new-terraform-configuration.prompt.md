...
7. **Documentation & Integration**
   - Update `CHANGELOG.md` with new configuration entry
   - Ensure README.md will be auto-generated by GitHub Actions
   - Verify all repository standards compliance
```
...
- [ ] All repository standards and instructions followed
...
This enhanced prompt creates actionable GitHub issues that eliminate ambiguity and ensure successful Terraform configuration implementation through automated agents.